...
| US-1.5 | 관리자로서, 교수 정보(이름, 담당 학생, 연락처)를 등록/관리하고 싶다 | 설정 > 교수 관리 페이지에서 CRUD | 🔜 예정 |
...
| 기능 | 포함 | 구현 상태 |
|------|------|-----------|
| FEAT-1 케이지 배정/해제 | ✅ | ✅ 완료 (API + UI) |
| 랙 설정 (CRUD) | ✅ | ✅ 완료 |
| 교수 설정 (CRUD) | ✅ | 🔜 M3-4에서 진행 |
| 기본 인증 (이메일+비밀번호) | ✅ | 🔜 M2에서 진행 |

### 6.2 2차 배포 범위 (선택)

| 기능 | 상태 |
|------|------|
| FEAT-2 실시간 현황판 | 🔜 M4-1, M4-2 |
| FEAT-3 과금 리포트 | 🔜 M4-3 |
